...
function createCards(cardAmount) {
  ...
  for (let i = 0; i < cardAmount; i++) {
    ...
    card_list.innerHTML += `<div class="col-md-2 col-sm-${cell} col-${cell} px-2">
      <div class="myCard">
...
function activate(ele) {
  if (ele.requestFullscreen) {
    document.getElementById("wide").classList.add("d-none");
    document.getElementById("narrow").classList.remove("d-none");
...
function deactivate() {
  if (document.exitFullscreen) {
    document.getElementById("narrow").classList.add("d-none");
    document.getElementById("wide").classList.remove("d-none");
